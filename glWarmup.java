...
public class glWarmup extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener, ActionListener{
	...
	// a set of shapes
	private static final int Triangle = 0, Torus = 1, Sphere = 2, Icosahedron = 3, Teapot = 4, Cone = 5, Octahedron = 6;
	...
	// constructor
	public glWarmup() {
		super("Intro Graphics Assignment 0");
		canvas = new GLCanvas();
	...
	public void drawShape() {
		...
		case Teapot:
			...
			break;
		case Cone:
			glut.glutSolidCone(1.5f, 1.5f, 20, 40);
			break;
		case Octahedron:
